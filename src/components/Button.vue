<template>
  <button
    class="w-fit rounded-full bg-primary-200 transition duration-150 hover:scale-105 hover:bg-secondary-300 disabled:hover:scale-100"
    :class="{
      [`text-white shadow-md`]: type === 'main',
